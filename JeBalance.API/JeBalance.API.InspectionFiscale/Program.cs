...
builder.Services.AddDbContext<InspectFiscaleAuthDbContext>(options =>
...
// For Identity
builder.Services
    .AddIdentity<InspectionFiscaleUser, IdentityRole>()
    .AddEntityFrameworkStores<InspectFiscaleAuthDbContext>()
